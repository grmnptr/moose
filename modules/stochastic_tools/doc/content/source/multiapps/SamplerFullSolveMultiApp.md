...
allows for an inputted reporter value to determine whether a sub-app should
be run for a certain sample. An example of using this parameter can be found in
