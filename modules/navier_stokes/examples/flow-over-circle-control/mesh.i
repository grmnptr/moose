[Mesh]
  ...
  #   num_sectors = '${fparse refinement*3}'
  #   radii = '${circle_radius} ${fparse 1.2*circle_radius}'
  #   rings = '2 ${fparse refinement} ${fparse 2*refinement}'
  #   has_outer_square = on
  #   pitch = ${pitch}
