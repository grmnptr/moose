    ...
    _activation_function(MultiMooseEnum("relu sigmoid elu gelu linear", "relu"))
{
  ...
  checkHiddenLayerParameterErrors();
...
void
LibtorchArtificialNeuralNet::checkHiddenLayerParameterErrors()
{
...
template <>
void
dataStore<Moose::LibtorchArtificialNeuralNet>(std::ostream & stream,
                                              ...
                                              void * context)
{
  ...
  std::shared_ptr<Moose::LibtorchArtificialNeuralNet> shared_nn(&nn);
  torch::save(shared_nn, nn.name());
}

template <>
void
dataLoad<Moose::LibtorchArtificialNeuralNet>(std::istream & stream,
                                             Moose::LibtorchArtificialNeuralNet & nn,
                                             void * context)
{
  std::string name;
